...
class PointCloudPublisher(Node):
    def __init__(self):
        ...
        self.depth_image_sub = message_filters.Subscriber(
            self, Image, "/depth_streamer/depth_image"
        )
        self.depth_image_info_sub = message_filters.Subscriber(
            self, CameraInfo, "/depth_streamer/camera_info"
        )
    ...
    def on_frames_received(
        ...
        pc2 = point_cloud(
            points,
            parent_frame=depth_image_msg.header.frame_id,
